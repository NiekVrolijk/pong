...
public class mysteryPaddle1 : MonoBehaviour
{
    //var
    ...
    public float maxXValue = 8.85f;
    public float minXValue = 0.15f;
    ...
    void paddleControl(KeyCode up,KeyCode down,KeyCode left,KeyCode right)
    {
        ...
        else if (Input.GetKey(left) && transform.position.x > -maxXValue && mysteryCollision.mysteryCount > 11 && mysteryCollision.mysteryCount < 24)
        {

            transform.Translate(Vector3.left * speed * Time.deltaTime);
        }
        else if (Input.GetKey(right) && transform.position.x < -minXValue && mysteryCollision.mysteryCount > 11 && mysteryCollision.mysteryCount < 24)
        {
        ...
        else if (Input.GetKey(right) && transform.position.x > -maxXValue  && mysteryCollision.mysteryCount > 23)
        {

            transform.Translate(Vector3.left * speed * Time.deltaTime);
        }
        else if (Input.GetKey(left) && transform.position.x < -minXValue  && mysteryCollision.mysteryCount > 23)
        {
